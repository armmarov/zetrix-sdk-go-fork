...
var errm = map[int]string{
	...
	INVALID_INITBALANCE_ERROR:                 "InitBalance must be between 0 and max(int64).",
	...
	INVALID_ISSUE_AMMOUNT_ERROR:               "AssetAmount this will be issued must be between 1 and max(int64).",
